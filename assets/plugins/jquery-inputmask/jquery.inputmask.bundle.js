    ...
    return modules = [function(module, exports, __webpack_require__) {
            ...
            Inputmask.prototype = {
                ...
                definitions: {
                    ...
                    "/": {
                        validator: "[0-9A-Za-z\u0410-\u044f\u0401\u0451\xc0-\xff\xb5_.-]",
                        cardinality: 1
                    }
                },
                aliases: {},
            ...
            module.exports = function maskScope(actionObj, maskset, opts) {
                ...
                function revalidateMask(pos, validTest, fromIsValid, validatedPos) {
                    ...
                    if (pos.begin > pos.end && (begin = pos.end, end = pos.begin), validatedPos = void 0 !== validatedPos ? validatedPos : begin,
                        ...
                        var positionsClone = $.extend(!0, {}, maskset.validPositions),
                            lvp = void 0 === validTest && !1 === opts.insertMode ? pos.end - 1 : getLastValidPosition(void 0, !0),
                            i;
                        ...
                        if (i = j, validTest && (maskset.validPositions[validatedPos] = $.extend(!0, {}, validTest),
                                posMatch++, j++, begin < end && i++), validTest || opts.insertMode)
                            for (; i <= lvp; i++) {
                ...
                function handleRemove(input, k, pos, strict, fromIsValid) {
                    ...
                    else if (!0 !== strict && (maskset.p = pos.begin, !0 !== fromIsValid && 0 !== maskset.p))
