...
/*_____________________Comprobar que no exista un proceso en la misma fecha_________________________*/

	$sql = "SELECT idprocesos 
			FROM tbl_procesos 
			WHERE fechafindevuelveresultado >= '".$fecha_inicio_incripcion."'";
	$respuesta=[];
	
	$resultado = $conexion->ejecutarInstruccion($sql);
	if($conexion->cantidadRegistros($resultado)>0){
		$respuesta["mensaje"]="El proceso se traslapa con un proceso existente.";
		$respuesta["codigo"]=-1;
	}else{
			...
			"`estado`) ".
			"VALUES ".
			"('$idUltimoproceso' , '$fecha_inicio_incripcion' , '$fecha_fin_incripcion' , '$fecha_inicio_test' , '$fecha_fin_test' , '$url_test_vocacional' , '$url_test_personalidad' , '$clave_acceso' , '$fecha_inicio_entrev' , '$fecha_fin_entrev' , '$fecha_inicio_devoluc', '$fecha_fin_devoluc', '$estado') ";
			/*
			FORMATO DE DATOS 
			---------------secciones------------------
			dia0=Agosto 20, 2019&Hora_Inicial0=02:00 PM&Hora_final0=03:00 PM&Lugar0=n&Cupos0=7&idSeccion0=201973162745976
